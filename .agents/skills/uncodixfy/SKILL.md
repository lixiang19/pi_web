---
name: uncodixfy
description: 防止在生成前端代码时出现通用的 AI/Codex UI 模式。在生成 HTML、CSS、React、Vue、Svelte 或任何前端 UI 代码时，请使用此技能，以强制执行受 Linear、Raycast、Stripe 和 GitHub 等设计理念启发的简洁、人性化的美学设计，而不是典型的 AI 生成的 UI
---
