...
> **图例**：✅ = 已实现且有测试/验收证据；N/A = 该维度不适用，不代表缺口。V2 阶段 6 后，矩阵不再保留仅入口、占位或半完成状态。

| 功能 | 导航入口 | API | DB | 前端 | 测试 | E2E | 归档 |
|------|------|------|------|------|------|------|------|
| 00 工作空间初始化 | ✅ | ✅ | ✅ | ✅ | ✅ | N/A | ✅ |
| 01 ridge DB 基础表与迁移框架 | N/A | ✅ | ✅ | N/A | ✅ | N/A | ✅ |
| 02 隐藏 ridge 目录与路径边界 | N/A | ✅ | ✅ | N/A | ✅ | N/A | ✅ |
| 03 工作台 Shell 与标签系统 | ✅ | N/A | N/A | ✅ | ✅ | ✅ | ✅ |
| 04 左侧导航固定入口与会话列表 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| 05 工作空间主页与会话创建 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| 06 会话索引归档与只读状态 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| 07 会话界面与右侧工作侧栏 | ✅ | N/A | N/A | ✅ | ✅ | ✅ | ✅ |
| 08 任务里程碑数据模型 | ✅ | ✅ | ✅ | ✅ | ✅ | N/A | ✅ |
| 09 任务列表详情与状态流转 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| 10 任务处理会话与任务 Agent | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| 11 规划工具与完成确认边界 | N/A | ✅ | N/A | N/A | ✅ | N/A | ✅ |
| 12 闪念数据模型与 Web 入口 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| 13 闪念临时附件生命周期 | ✅ | ✅ | ✅ | ✅ | ✅ | N/A | ✅ |
| 14 桌面采集入口 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
...
| 30 项目注册与内部项目外部仓库 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| 31 设备注册在线状态与调度 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| 32 runtime bundle 与设备专属 Skill | N/A | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| 33 workspace MCP 查读工具 | N/A | ✅ | ✅ | N/A | ✅ | N/A | ✅ |
| 34 通知与建议中心 | ✅ | ✅ | ✅ | ✅ | ✅ | N/A | ✅ |
| 35 task review agent 任务回顾 | ✅ | ✅ | ✅ | ✅ | ✅ | N/A | ✅ |
| 36 自动化规则运行与跳过 | ✅ | ✅ | ✅ | ✅ | ✅ | N/A | ✅ |
| 37 备份恢复设置主题收尾 | ✅ | ✅ | ✅ | ✅ | ✅ | N/A | ✅ |
| 38 AI 对话主线闭环 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| 43 V2 阶段 1 主会话资源与 Agent 运行体验 | ✅ | ✅ | ✅ | ✅ | ✅ | N/A | ✅ |
| 44 V2 阶段 2 文件附件空间隐藏版本 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| 45 V2 阶段 3 桌面端与本机项目上线闭环 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| 46 V2 阶段 4 备份恢复设置错误边界 | ✅ | ✅ | ✅ | ✅ | ✅ | N/A | ✅ |
| 47 V2 阶段 5 知识系统可诊断化 | ✅ | ✅ | ✅ | ✅ | ✅ | N/A | ✅ |
| 48 V2 阶段 6 上线质量门禁 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| 50 Android 移动端工程骨架 | N/A | N/A | N/A | ✅ | ✅ | ⏳ SDK 环境阻塞 | ⏳ |
| 51 Android 设备注册与服务连接 | N/A | ✅ | ✅ | ✅ | ✅ | N/A | ✅ |
...
| 64 闪念分析结构化工具输出 | N/A | ✅ | ✅ | N/A | ✅ | N/A | ✅ |
| 68 内置闪念 Agent 真实处理 | N/A | ✅ | ✅ | N/A | ✅ | N/A | ✅ |
| 67 subagent 权限命名收口 | N/A | ✅ | N/A | N/A | ✅ | N/A | ✅ |
...
- **15/64/68 内置闪念 Agent 真实处理**：闪念创建后异步入队 `fleeting.analyze`，worker 不再直接调用 `@mariozechner/pi-ai complete()` 输出建议 JSON，而是创建内存 `AgentSession` 启动不可见内置 `fleeting-agent`。该 Agent 是真实运行 Agent，可读写工作空间、运行 bash、使用任务/里程碑规划工具，并通过统一 `complete_internal_task` 汇报 `completed/failed` 和 summary。`fleeting-agent` 配置 `visible:false`，前端 `/api/agents` 不返回，普通主会话不能选择，普通 Agent 也不能通过 `subagent` 调用；权限配置只显式拒绝 `ask: deny` 与 `subagent: deny`。Web 文件/音频捕捉仍走 multipart 临时附件上传到 `.ridge/fleeting-attachments/<noteId>/`，worker 会把文本类附件前缀或 Python Converter 转换后的正文放入内部 Agent prompt。Agent 调用完成工具成功时写 `fleeting_notes.status='processed'`、`analysis_status='processed'`；主动失败时写 `analysis_status='failed'` 和 `last_error` 且 job 完成；运行异常或未调用完成工具进入后台 job 重试/最终失败路径。`fleeting-analysis.test.ts` 覆盖真实内部 Agent 会话、统一完成工具、权限裁剪、主动失败和未完成重试。
...
- **26 summary agent daily L1 会话记忆**：`POST /api/sessions/:sessionId/end` 结束会话并排队 `summary.daily`；关闭会话 tab 会调用该入口；summary agent 只读 session 文件，通过基础 `@mariozechner/pi-ai complete()` 输出 Markdown 正文，服务端追加到 `记忆/daily/YYYY/MM/YYYY-MM-DD.md` 对应日期小节；不生成单会话摘要文件；同一 daily date 串行写入，不同 session 不误去重。`workspace-memory.test.ts` 与 `background-jobs.test.ts` 覆盖。
- **27 memory agent L2/L3 维护与注入**：`memory.maintain` 在 summary 后启动不可见内置 `memory-agent`，真实读写 `记忆/scenarios/<scenario-slug>.md` 与 `记忆/MEMORY.md`；`MEMORY.md` 只保留当前启动注入需要的 `[scope][date]` 有效结论；`memory-agent` 权限固定为 `ask/subagent/bash: deny`，编辑只允许记忆目录，并通过统一 `complete_internal_task` 汇报结果；消息入口支持显式“记住/忘掉”立即改写；新会话启动和 resource reload 注入 `MEMORY.md` 与 `Wiki/index.md` XML 块，空文件不注入，并包含“记忆可能过时，当前用户最新话语和当前文件事实优先”提醒。`workspace-memory.test.ts` 覆盖。
...
> **注**：V2 阶段 6 已把未归档任务文档迁入 `文档/功能开发/归档/`，并用 `release-gate.test.ts` 守住矩阵不再出现占位、半完成或未归档状态。
