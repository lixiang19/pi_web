...
const CORE_TABLE_COLUMNS: Record<string, ColumnDefinition[]> = {
  ...
  sessions: [
    ...
    { name: 'session_file', definition: "TEXT NOT NULL DEFAULT ''" },
    { name: 'parent_session_path', definition: 'TEXT' },
    { name: 'parent_session_id', definition: 'TEXT' },
    { name: 'created_at', definition: 'INTEGER NOT NULL DEFAULT 0' },
    { name: 'updated_at', definition: 'INTEGER NOT NULL DEFAULT 0' },
    { name: 'archived', definition: 'INTEGER NOT NULL DEFAULT 0' },
    { name: 'readonly', definition: 'INTEGER NOT NULL DEFAULT 0' },
    { name: 'context_id', definition: "TEXT NOT NULL DEFAULT ''" },
    { name: 'user_round_count', definition: 'INTEGER NOT NULL DEFAULT 0' },
    { name: 'last_model', definition: 'TEXT' },
    { name: 'last_thinking_level', definition: 'TEXT' },
  ],
