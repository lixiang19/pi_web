...
const CORE_TABLE_COLUMNS: Record<string, ColumnDefinition[]> = {
  ...
  search_index_status: [
    ...
    { name: 'refresh_policy', definition: "TEXT NOT NULL DEFAULT 'immediate'" },
    { name: 'last_event', definition: "TEXT NOT NULL DEFAULT 'manual'" },
  ...
  search_chunks: [
    { name: 'target_path', definition: "TEXT NOT NULL DEFAULT ''" },
    { name: 'source_path', definition: "TEXT NOT NULL DEFAULT ''" },
    { name: 'heading_path', definition: "TEXT NOT NULL DEFAULT '[]'" },
    { name: 'chunk_index', definition: 'INTEGER NOT NULL DEFAULT 0' },
    { name: 'chunk_text', definition: "TEXT NOT NULL DEFAULT ''" },
    { name: 'content_hash', definition: "TEXT NOT NULL DEFAULT ''" },
    { name: 'file_type', definition: "TEXT NOT NULL DEFAULT 'markdown'" },
    { name: 'embedding_id', definition: "TEXT NOT NULL DEFAULT ''" },
    { name: 'embedding_vector', definition: "TEXT NOT NULL DEFAULT '[]'" },
    { name: 'start_line', definition: 'INTEGER NOT NULL DEFAULT 1' },
    { name: 'end_line', definition: 'INTEGER NOT NULL DEFAULT 1' },
    { name: 'created_at', definition: 'INTEGER NOT NULL DEFAULT 0' },
    { name: 'updated_at', definition: 'INTEGER NOT NULL DEFAULT 0' },
  ],
  notification_events: [
    ...
    { name: 'source', definition: "TEXT NOT NULL DEFAULT ''" },
    ...
    { name: 'actions_json', definition: "TEXT NOT NULL DEFAULT '[]'" },
    { name: 'payload_json', definition: "TEXT NOT NULL DEFAULT '{}'" },
    { name: 'status', definition: "TEXT NOT NULL DEFAULT 'unread'" },
    { name: 'created_at', definition: 'INTEGER NOT NULL DEFAULT 0' },
    { name: 'updated_at', definition: 'INTEGER NOT NULL DEFAULT 0' },
    { name: 'read_at', definition: 'INTEGER' },
    { name: 'handled_at', definition: 'INTEGER' },
  ],
  ...
  device_bundle_acks: [
    { name: 'bundle_id', definition: "TEXT NOT NULL DEFAULT ''" },
    { name: 'acked_at', definition: 'INTEGER NOT NULL DEFAULT 0' },
    { name: 'created_at', definition: 'INTEGER NOT NULL DEFAULT 0' },
    { name: 'updated_at', definition: 'INTEGER' },
    { name: 'content_hash', definition: 'TEXT' },
    { name: 'bundle_version', definition: 'INTEGER NOT NULL DEFAULT 1' },
    { name: 'sync_status', definition: "TEXT NOT NULL DEFAULT 'acked'" },
    { name: 'sync_error', definition: 'TEXT' },
    { name: 'sync_attempts', definition: 'INTEGER NOT NULL DEFAULT 0' },
  ],
  device_bundle_served: [
    ...
    { name: 'bundle_version', definition: 'INTEGER NOT NULL DEFAULT 1' },
    { name: 'project_id', definition: 'TEXT' },
    { name: 'project_path', definition: 'TEXT' },
    { name: 'served_at', definition: 'INTEGER NOT NULL DEFAULT 0' },
    { name: 'materialized', definition: 'INTEGER NOT NULL DEFAULT 0' },
    { name: 'materialized_hash', definition: 'TEXT' },
  ],
};
