...
const CORE_TABLE_COLUMNS: Record<string, ColumnDefinition[]> = {
  ...
  fleeting_notes: [
    ...
    { name: 'status', definition: "TEXT NOT NULL DEFAULT 'pending'" },
    { name: 'analysis_status', definition: "TEXT NOT NULL DEFAULT 'unanalyzed'" },
    { name: 'type', definition: "TEXT NOT NULL DEFAULT 'text'" },
    { name: 'suggestion', definition: 'TEXT' },
  ...
  fleeting_attachments: [
    ...
    { name: 'temp_path', definition: "TEXT NOT NULL DEFAULT ''" },
    { name: 'final_path', definition: 'TEXT' },
