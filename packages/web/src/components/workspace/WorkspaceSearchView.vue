...
import { FileText, FolderSearch, LoaderCircle, RefreshCcw, Search } from "lucide-vue-next";
...
import { refreshWorkspaceRag, searchWorkspace } from "@/lib/api";
import type { WorkspaceSearchResponse, WorkspaceSearchResult, WorkspaceSearchResultType } from "@/lib/types";
...
<template>
  <div class="flex h-full min-h-0 flex-col bg-background">
    ...
    <ScrollArea class="min-h-0 flex-1">
      <div v-if="!response && !isLoading" class="flex h-full min-h-[320px] items-center justify-center px-6 text-sm text-muted-foreground">
